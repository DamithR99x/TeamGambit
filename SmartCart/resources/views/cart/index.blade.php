...
<head>
    ...
    <title>Shopping Cart - SmartCart</title>
            ...
            <div class="col-12">
                ...
                @else
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($cartItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('cart.remove', $item->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to remove this item?')">Remove</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td>${{ number_format(Cart::getTotal() - Cart::getSubTotal(), 2) }}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-end fw-bold">Total:</td>
                                    <td class="fw-bold">${{ number_format(Cart::getTotal(), 2) }}</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div>
                            <a href="{{ route('cart.clear') }}" class="btn btn-outline-danger me-2" onclick="return confirm('Are you sure you want to empty your cart?')">Empty Cart</a>
