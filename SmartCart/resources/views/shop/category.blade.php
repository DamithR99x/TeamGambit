    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('shop.category', $category->slug) }}" method="GET" id="filter-form">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('shop.category', $category->slug) }}" class="btn btn-outline-secondary">Clear Filters</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="list-group">
                        ...
                        <a href="{{ route('shop.category', $child->slug) }}" class="list-group-item list-group-item-action">
                            {{ $child->name }}
                        </a>
                        @endforeach
                    </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <a href="{{ route('shop.category', $category->parent->slug) }}" class="btn btn-outline-primary d-block">
                        <i class="fas fa-arrow-up me-2"></i> {{ $category->parent->name }}
                    </a>
                </div>
            </div>
            @endif
                ...
                @empty
                    <div class="col-12">
                        <div class="alert alert-info">
                            No products found in this category. Try adjusting your filters or check back later.
                        </div>
                    </div>
                @endforelse
            </div>
